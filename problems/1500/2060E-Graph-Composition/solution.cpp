...
void solve() {
    ...
    vpii edges;
    rep(i, 0, m1){
        int u, v; r(u, v); edges.pb({u,v});
    }
    DSU a(n);
    rep(i, 0, m2)
    {
        int u, v; r(u, v); a.unite(u,v);
    }
    rep(i, 1, n+1){
        a.find(i);
    }
    ...
    vpii cor_edges;
    rep(i, 0, m1){
        if(a.parent[edges[i].fi]==a.parent[edges[i].se])
        {
            cor_edges.pb (edges[i]);
        }
        else
        {
            operations++;
    ...
    DSU b(n);
    rep(i, 0, sz(cor_edges)){
        b.unite(cor_edges[i].fi, cor_edges[i].se);
    }
    rep(i, 1, n+1){
        b.find(i);
    }
