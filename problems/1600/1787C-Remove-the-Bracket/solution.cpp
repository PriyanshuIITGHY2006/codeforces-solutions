        ...
        if (a[i+1] > 2 * s)
        {
            ...
            else if (i == n - 2)
            {
                ...
                if (a[i] > 2 * s)
                {
                    ...
                    y = max(0ll, a[i] - s);
                dp[i][0] = min(dp[i - 1][1] + y * a[i + 1], dp[i - 1][0] + (a[i] - y) * a[i + 1]);
                dp[i][1] = min(dp[i - 1][1] + y * a[i + 1], dp[i - 1][0] + (a[i] - y) * a[i + 1]);
            }
            else
            {
                int y;
                if (a[i] > 2 * s)
                {
                    ...
                    y = max(0ll, a[i] - s);
                dp[i][0] = min(dp[i - 1][1] + y * s, dp[i - 1][0] + (a[i] - y) * s);
                dp[i][1] = min(dp[i - 1][1] + y * (a[i + 1] - s), dp[i - 1][0] + (a[i] - y) * (a[i + 1] - s));
            }
        }
        else
        {
            if (i == 0)
            {
                dp[i][0] = a[0] * max(0ll, a[i + 1] - s);
                dp[i][1] = a[0] * (a[i + 1] - max(0ll, a[i + 1] - s));
            }
            else if (i == n - 2)
            {
                int y;
            ...
            else
            {
                ...
                if (a[i] > 2 * s)
                {
                    ...
                    y = max(0ll, a[i] - s);
                dp[i][0] = min(dp[i - 1][1] + y * max(0ll, a[i + 1] - s), dp[i - 1][0] + (a[i] - y) * max(0ll, a[i + 1] - s));
                dp[i][1] = min(dp[i - 1][1] + y * (a[i + 1] - max(0ll, a[i + 1] - s)), dp[i - 1][0] + (a[i] - y) * (a[i + 1] - max(0ll, a[i + 1] - s)));
            }
        }
    }
    o(dp[n - 2][0]);
