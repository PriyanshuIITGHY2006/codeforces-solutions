...
void solve() {
    ...
    fbc=m/lcm(b,c);
    fac=m/lcm(c,a);
    fabc=m/lcm(b, lcm(a,c));
    ll ansa=(fa-fab-fac+fabc)*6+(fab+fac-2*fabc)*3 +fabc*2;
    ll ansb=(fb-fbc-fab+fabc)*6+(fbc+fab-2*fabc)*3 +fabc*2;
    ll ansc=(fc-fac-fbc+fabc)*6+(fac+fbc-2*fabc)*3 +fabc*2;
    cout<<ansa<<" "<<ansb<<" "<<ansc<<" "<<"\n";
